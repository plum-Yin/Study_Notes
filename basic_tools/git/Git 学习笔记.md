...
![](https://s2.loli.net/2023/02/08/7lQs2iZgVvcWIf8.jpg)
...
如果文件只放入了暂存区，还没有放入版本库。命令`git reset HEAD <file>`可以把暂存区的修改撤销掉（unstage），重新放回工作区。
...
git branch -M main
git remote add origin https://github.com/plum-Yin/learngit.git
